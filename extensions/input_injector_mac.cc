...
protocol::MousePosition InputInjectorMac::GetMousePosition()
{
  protocol::MousePosition pos;
  base::ScopedCFTypeRef<CGEventRef> event(CGEventCreate(nil));
...
scoped_ptr<InputInjector> InputInjector::Create() {
  return scoped_ptr<InputInjector>(new InputInjectorMac());
}
